...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::createWithRect("bubble-mubble", cocos2d::Rect(0, 0, Globals::designResoluton.width, Globals::designResoluton.height));
#else
        glview = GLViewImpl::create("bubble-mubble");
#endif
